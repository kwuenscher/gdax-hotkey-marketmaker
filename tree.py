...
class Tree(object):
    ...
    def __init__(self):
        ...
        self.price_map = defaultdict()
        self.order_map = defaultdict()
        self.received_orders = defaultdict()
        self.redundant =[]
    ...
    def insert_order(self, order_id, size, price, initial=False):
        self.redundant.append(order_id)
        if not initial:
    ...
    def remove_order(self, order_id):
        ...
        elif order_id in self.received_orders.keys():
            del self.received_orders[order_id]
        else:
            None #print('invalid order id detected')
